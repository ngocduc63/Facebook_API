...
ERROR_USER_WAS_BLOCKED = create_error_code(25, "user was blocked")
ERROR_SHARE_YOUR_SELF_POST = create_error_code(26, "error share your self post")
ERROR_CHECK_WORD = create_error_code(27, "error check word")
